        ...
        <div className="w-full min-h-[200px] grid grid-cols-1 md:grid-cols-2 py-10 gap-4 justify-between">
          ...
          <div className="">
            <p className="text-sm md:text-base lg:text-lg font-medium text-gray-700">
              HMO is the premier Lifecycle management tool designed for Health
              assurance. There are a number of reasons why you may want to use
              Lifecycle to manage your Yourself and families Health.
            </p>
          </div>
        </div>
        <Cards />
